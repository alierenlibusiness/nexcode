...
- **Rapora değil koda güven.** "Yaptım/geçti" ifadesini doğrulama sayma; değişen dosyayı ve
  etkilediği çağrı yerlerini kendin oku.
...
`VERDICT: FAIL` olmalıdır. Bu işaretçi motor tarafından okunur ve **hiçbir dilde çevrilmez**.
